...
modelpath = "saved_models/forward_first/mnist_hybrid_digits_patches_v0/a_sample_len=8_add_offset=true_asz=6_bsz=64_esz=32_glimpse_len=4_ha_sz=32_img_channels=1_imzprod=784_scale_offset=2.4_seqlen=5_α=1.0_β=0.1_β_enc=0.1_η=0.0001_λ=0.0001_λpatch=0.25_π=64_50eps.bson"

Hx, Encoder = load(modelpath)[:model] |> gpu
